...
export const ModeSelectionScreen: React.FC<ModeSelectionScreenProps> = ({
  ...
  return (
    <div
      ...
      className="w-full min-h-[calc(100vh-4rem)] flex flex-col items-center justify-center px-4 sm:px-8 py-10 bg-slate-50 dark:bg-[#07090c] text-slate-900 dark:text-white select-none relative overflow-hidden transition-colors"
    >
